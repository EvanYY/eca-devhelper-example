            ...
            effect: [
              {
                ...
                result: {
                  ...
                  newValue: {
                    contextRoleOrgIds: { SalesOrg: "1U2VDW52DUM002M" },
                  },
                },
                time: 1637229178523,
                sequence: 1613,
              ...
              },
              {
                ...
                result: {
                  ...
                  newValue: {
                    ...
                    bindVars: [
                      { name: "salesOrgId", value: "1U2VDW52DUM002M" },
                    ],
                    type: "and",
                  },
                },
    ...
    data: JSON.stringify([
      ...
      },
      {
        ...
        params: {
          ...
          effects: [
            ...
            {
              props: {
                "contextRoleOrgIds.FinancialOrg": "$current.createdOrg.id",
              },
              isDestruct: true,
              when: "$current.createdOrg.id",
              fireImmediately: true,
      ...
      },
      {
        ...
        params: {
          ...
          effects: [
            ...
            {
              props: {
                "contextRoleOrgIds.FinancialOrg": "$root.createdOrg.id",
              },
              isDestruct: true,
              when: "$root.createdOrg.id",
              fireImmediately: true,
      ...
      },
      {
        ...
        params: {
          ...
          fragment: {
            criteriaStr:
              "productFeatures.productType.id in ('ProductType.sales')",
            fireImmediately: true,
          },
        },
        store: { description: "", reference: "revenueConfirmationItems" },
